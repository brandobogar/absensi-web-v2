...
export default function ManajemenPegawai({ callApi, onKembali }) {
    ...
    <div className="min-h-screen bg-slate-100">
        ...
        <div className="mb-4">
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 pr-10 text-sm text-slate-700 placeholder:text-slate-400 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition"
            />
        ...
        {loading && pegawaiList.length === 0 ? (
          ...
          <div className="rounded-2xl bg-white border border-slate-200 px-6 py-12 text-center">
            ...
            <button
              type="button"
              onClick={() => setShowTambah(true)}
              className="mt-5 rounded-lg bg-green-600 px-4 py-2 text-sm font-semibold text-white hover:bg-green-700 transition"
            >
              + Tambah Pegawai
            </button>
          </div>
          ...
          =================================================== */
          <div className="rounded-2xl bg-white border border-slate-200 px-6 py-14 text-center">
            <div className="text-4xl mb-3">🔎</div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-4 py-3 border-b border-slate-50">
                    ...
                    {updatingStatus ? (
                      <div className="h-5 w-5 animate-spin rounded-full border-2 border-slate-200 border-t-blue-600 shrink-0" />
                    ) : (
                      <button
                        type="button"
                        role="switch"
      ...
      {saving && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="flex flex-col items-center rounded-2xl bg-slate-900/90 px-7 py-6 shadow-xl">
